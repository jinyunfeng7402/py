...
def pornhub_downloader(driver, url, save_path):
    ...
    # 选择最高清的版本
    download_url = data[-2]['videoUrl']

    # 下载
    print(f"分辨率{data[-2]['quality']}P的下载地址为：{download_url}")
    download_from_url(download_url, os.path.join(save_path, data[-2]['quality']+'P'+'_'+video_name+'.mp4'))
